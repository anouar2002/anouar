...
namespace Helpers
{
    ...
    public static class LoginLinkHelper
    {
        public static string LoginLink(this HtmlHelper helper)
        {
            ...
            if (currentControllerName.Equals("Account", StringComparison.CurrentCultureIgnoreCase) && (currentActionName.Equals("Se connecter", StringComparison.CurrentCultureIgnoreCase) || currentActionName.Equals("Logout", StringComparison.CurrentCultureIgnoreCase)))
            ...
            if (isAuthenticated)
            {
                sb.Append(helper.ActionLink("Déconnecter", "Logout", "Account"));
            }
            else
            {
                sb.Append(helper.ActionLink("Se connecter", "Logon", "Account"));
            }
            sb.Append("</div>");
            return sb.ToString();
        }
